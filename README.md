local placeId = game.PlaceId
	...
	if placeId == 2753915549 then --- Blox Fruit Old
		...
		if game.CoreGui:FindFirstChild("CPU Hub - Blox Fruit (Starter World)") then
			game.pCoreGui:FindFirstChild("CPU Hub - Blox Fruit (Starter World)"):Destroy()
		end
...
do
	...
	function section:updateDropdown(dropdown, title, list, callback)
		...
		local L9s0 = library.new("CPU Hub ")
		...
		local S9s04 = M9s0:addSection("Local Player")
	...
	if placeId == 4442272183 then --- Blox Fruit New World
		...
		if game.CoreGui:FindFirstChild("CPU HUB") then
			game.CoreGui:FindFirstChild("CPU HUB"):Destroy()
		end
		...
		local S9s03IIII = M9s0:addSection("Auto Raids")
		...
		S9s08:addButton("Copy Link Discord",function()
			...
			setclipboard("https://discord.gg/VAThCQEPxv")
		end)

		S9s08:addButton("Credit",function()

                                               L9s0:Notify("CREDIT ", "Src By 9s0 Hub Thx you form CPU")
		end)
	end

	if placeId == 189707 then --- Natural Disaster Survival

		if game.CoreGui:FindFirstChild("CPU HUB - Natural Disaster Survival") then
			game.CoreGui:FindFirstChild("CPU HUB - Natural Disaster Survival"):Destroy()
		end
		...
		S9s03:addKeybind("Hide UI", Enum.KeyCode.RightControl, function()
			L9s0:toggle()
		end, function()
